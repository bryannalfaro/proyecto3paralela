 ...
 * @brief Global and constant memory implementation of the Hough transform
 * @version 0.1
 * @date 2023-05-09
 *
...
/**
 * @brief GPU kernel. One thread for every pixel. Constant and global memory
 * @param pic image to process
 * @param w width of image
 * @param h height of image
...
cudaEventCreate(&stop);
  ...
  GPU_HoughTranConst <<< blockNum, 256 >>> (dIn, w, h, dHough, rMax, rScale);
